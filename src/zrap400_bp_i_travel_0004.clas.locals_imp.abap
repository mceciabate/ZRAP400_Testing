  " local test classes
  "Info: The addition DEFERRED of the statement CLASS is used to make a class known temporarily
  "in a program, regardless of the location of its implementation in the program.
  ...
  FRIENDS ltc_writing_methods ltc_readonly_methods.
